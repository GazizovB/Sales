...
namespace Sales
{
    ...
    {
        string connectSqlServer = ConfigurationManager.ConnectionStrings["appConnection1"].ConnectionString;
        string connectionString = ConfigurationManager.ConnectionStrings["appConnection2"].ConnectionString;
        ...
        {
            string sqlQuery = "CREATE DATABASE MyDatabase";
            ...
            using (SqlConnection connection = new SqlConnection(builder.ConnectionString))
            {
                ...
                try
                {
                    ...
                    sql.CommandText = "insert into Clients values(1,'Alex','John')";
                    sql.ExecuteNonQuery();
                    sql.CommandText = "insert into Clients values(2,'Sara','Fara')";
                    sql.ExecuteNonQuery();

                    sql.CommandText = "insert into Sallers values(1,'Sergey','Sasha')";
                    sql.ExecuteNonQuery();
                    sql.CommandText = "insert into Sallers values(2,'Natan','Zlatan')";
                    sql.ExecuteNonQuery();
